...
class GestureIter(mx.io.DataIter):
    def __init__(self, fname, batch_size, seq_len, data_shape):
...
if __name__ == '__main__':
    ...
    network = cnn_concat(seq_len, num_hidden, num_label)

    train_file = '/data/zhigang.yang/gesture_train.txt'
    test_file = '/data/zhigang.yang/gesture_test.txt'

    data_train = GestureIter(train_file, batch_size, seq_len, data_shape)
    data_val = GestureIter(test_file, batch_size, seq_len, data_shape)
    ...
    model.save('./model/cnn_concat', 500)
